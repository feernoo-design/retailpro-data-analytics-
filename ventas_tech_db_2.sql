...
-- (Ejecutar la línea anterior por separado si tu motor lo requiere
--  antes de conectarte a la base y correr el resto del script)


-- ============================================================
-- 1) DROP TABLES
-- Orden inverso a las dependencias: primero la tabla de hechos
-- (ventas), luego las dimensiones que dependen de otras,
-- y al final las dimensiones sin dependencias.
-- ============================================================
...
-- luego productos, y al final ventas.
-- ============================================================
...
-- (Más adelante, en el Módulo 5, se van a cruzar estas tablas con JOIN
